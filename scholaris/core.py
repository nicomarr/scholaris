...
__all__ = ['T', 'generate_json_schema', 'json_schema_decorator', 'get_file_names', 'extract_text_from_pdf',
           ...
           'describe_python_code', 'query_openalex_api', 'query_semantic_scholar_api', 'respond_to_generic_queries',
           'show_response', 'Assistant', 'add_to_class', 'show_conversion_history', 'clear_conversion_history']
...
def query_openalex_api(identifyer: str, identifyer_type: str="title") -> str:
    ...
    if identifyer_type.lower() == "title":
        ...
        if len(raw_search_results['results']) == 0:
            return json.dumps({"number of search matches": number_of_search_matches, "search result": "None"})
