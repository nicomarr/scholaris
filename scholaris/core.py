"""The sections below describe the core functionality of **Scholaris**, including helper functions for JSON schema generation, local file processing, external data retrieval from sources like NCBI, Semantic Scholar and OpenAlex, and an Assistant class for simplified chat and tool use. Follow this [link to view the full source code](https://github.com/nicomarr/scholaris/blob/main/scholaris/core.py)."""
...
import inspect
from typing import Callable, Dict, List, Tuple, Optional, Any, Union, Generator, TypeVar
import json
import os
import sys
import io
